...
public class UserServiceTest {
    ...
    void findAll_dataCorrect_listOfUsersReturned() {
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertEquals(1L, users.getFirst().id()),
                () -> Assertions.assertEquals("example1@gmail.com", users.getFirst().email()),
                () -> Assertions.assertEquals("Jacek", users.getFirst().firstName()),
                () -> Assertions.assertEquals("Placek", users.getFirst().lastName()),
                () -> Assertions.assertEquals("123123123", users.getFirst().phoneNumber()),
                () -> Assertions.assertEquals(2L, users.get(1).id()),
                () -> Assertions.assertEquals("example2@gmail.com", users.get(1).email()),
                () -> Assertions.assertEquals("Marcin", users.get(1).firstName()),
                () -> Assertions.assertEquals("Radzki", users.get(1).lastName()),
                () -> Assertions.assertEquals("321321321", users.get(1).phoneNumber())
        );
    }
    ...
    void findByEmail_dataCorrect_userReturned() {
        ...
        //then
        Assertions.assertAll(
                () -> Assertions.assertEquals(1L, userReturned.id()),
                () -> Assertions.assertEquals("Example1@gmail.com", userReturned.email()),
                () -> Assertions.assertEquals("Mateusz", userReturned.firstName()),
                () -> Assertions.assertEquals("Markowski", userReturned.lastName()),
                () -> Assertions.assertEquals("123123123", userReturned.phoneNumber())
        );
    ...
    void update_userExists_updatedUserReturned() {
        ...
        Assertions.assertAll(
                () -> Assertions.assertEquals(1L, userDto.id()),
                () -> Assertions.assertEquals("example@email.com", userDto.email()),
                () -> Assertions.assertEquals("Marcin", userDto.firstName()),
                () -> Assertions.assertEquals("Nowak", userDto.lastName()),
                () -> Assertions.assertEquals("999999999", userDto.phoneNumber())
        );
    }
